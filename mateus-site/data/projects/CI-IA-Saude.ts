...
export const content: ContentBlock[] = [
  ...
  { type: 'text', value: 'Implementei uma arquitetura multimodal e hierárquica usando Aprendizado Federado. Os dados ficam no hospital, e apenas os pesos do modelo viajam.' },
