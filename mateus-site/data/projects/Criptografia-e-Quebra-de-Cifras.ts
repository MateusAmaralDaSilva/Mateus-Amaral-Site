...
export const content: ContentBlock[] = [
  ...
  { type: 'text', value: 'Desta forma conseguimos ter um sistema completo de comunicação via cifras, caso tenha interesse em testar lembre-se que quanto maior o texto menos trabalho voccê terá na parte manual.'}
]